  ...
  const projects = {
    ...
    zoomir: {
      ...
      beforeAfter: {
        ...
        issues: [
          "Hero шаблонный: стоковое фото и декоративные фигуры вместо атмосферы магазина",
          "Нет доверия и цифр на первом экране — только общий текст",
          "Ассортимент и маршрут покупки не читаются сразу",
          "Слабая иерархия и фирменный тон — бренд не запоминается",
        ],
      },
    },
  };
